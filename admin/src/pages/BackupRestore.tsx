...
export default function BackupRestore() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      await fetchBackups();
    } catch (err) { console.error('Failed to create backup', err); }
      ...
      <div className="page-header">
        ...
        <div className="page-actions">
          ...
          <div className="tabs">
            ...
            <button className="tab" onClick={() => handleExport('settings')} disabled={exporting}>
              Settings
            </button>
            <button className="tab" onClick={() => handleExport('content')} disabled={exporting}>
              Content
            </button>
          </div>
        </div>
              ...
              <tr key={b._id}>
                ...
                <td>
                  <div className="table-actions">
                    <button className="btn-view" onClick={() => handleRestore(b._id)} data-tooltip="Restore">
                      <Icon path={Icons['refresh-cw']} size={14} />
                    </button>
                    <button className="btn-delete" onClick={() => handleDelete(b._id)} data-tooltip="Delete">
