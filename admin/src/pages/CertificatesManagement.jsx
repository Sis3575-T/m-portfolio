    ...
    <div>
      ...
      <div className="media-grid">
        {certificates.map(cert => (
          <div key={cert._id} className="media-card" style={{ position: 'relative' }}>
            ...
            <div style={{ position: 'absolute', top: 8, right: 8, display: 'flex', gap: 4 }}>
              <button className="btn-icon" style={{ width: 28, height: 28, borderRadius: 6, background: 'rgba(0,0,0,0.5)', color: '#fff', border: 'none', cursor: 'pointer' }}
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="form-row">
                <div className="form-group"><label>Certificate Name <span style={{ color: 'var(--danger)' }}>*</span></label><input value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} /></div>
