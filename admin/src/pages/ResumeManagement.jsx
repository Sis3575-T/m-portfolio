...
export default function ResumeManagement() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .catch(() => toast.error('Failed to load resume files'))
  ...
  return (
    <div>
              ...
              <tr key={item._id}>
                ...
                <td>
                  <div className="table-actions">
                    <a href={imageUrl(item.url)} target="_blank" rel="noopener noreferrer" className="btn-view">
      ...
      <ConfirmDialog
        ...
        title="Delete Resume"
        message={`Delete "${deleteTarget?.originalName || deleteTarget?.name}"?`}
        confirmText="Delete"
        type="danger"
        loading={deleting}
      />
