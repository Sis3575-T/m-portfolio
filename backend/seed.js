  ...
  try {
    ...
    if ((await Skill.countDocuments()) === 0) {
      await Skill.insertMany([
        ...
        { name: 'Angular', category: 'Frontend', proficiency: 80, icon: 'FaAngular', isActive: true },
        { name: 'Next.js', category: 'Frontend', proficiency: 80, icon: 'SiNextdotjs', isActive: true },
        { name: 'Redux', category: 'Frontend', proficiency: 75, icon: 'SiRedux', isActive: true },
        { name: 'Bootstrap', category: 'Frontend', proficiency: 80, icon: 'SiBootstrap', isActive: true },
        { name: 'Axios', category: 'Frontend', proficiency: 70, icon: '', isActive: true },
        ...
        { name: 'C#', category: 'Backend', proficiency: 65, icon: 'SiCsharp', isActive: true },
        { name: 'Ruby', category: 'Backend', proficiency: 60, icon: 'SiRuby', isActive: true },
        { name: '.NET', category: 'Backend', proficiency: 65, icon: 'SiDotnet', isActive: true },
        { name: 'Ruby on Rails', category: 'Backend', proficiency: 60, icon: 'SiRubyonrails', isActive: true },
        ...
        { name: 'CI/CD', category: 'DevOps', proficiency: 70, icon: 'SiJenkins', isActive: true },
        { name: 'Containerization', category: 'DevOps', proficiency: 50, icon: '', isActive: true },
        { name: 'Git', category: 'Tools', proficiency: 82, icon: 'FaGitAlt', isActive: true },
        { name: 'Docker', category: 'Tools', proficiency: 50, icon: 'FaDocker', isActive: true },
        { name: 'Vite', category: 'Tools', proficiency: 75, icon: 'SiVite', isActive: true },
        { name: 'Postman', category: 'Tools', proficiency: 70, icon: 'SiPostman', isActive: true },
        { name: 'Figma', category: 'Tools', proficiency: 55, icon: 'FaFigma', isActive: true },
        { name: 'npm', category: 'Tools', proficiency: 78, icon: 'FaNpm', isActive: true },
        { name: 'Solidity', category: 'Other', proficiency: 50, icon: 'SiSolidity', isActive: true },
        { name: 'Web3', category: 'Other', proficiency: 55, icon: '', isActive: true },
      ]);
